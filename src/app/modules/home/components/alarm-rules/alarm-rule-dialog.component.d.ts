...
export declare class AlarmRuleDialogComponent extends DialogComponent<AlarmRuleDialogComponent, CalculatedField> {
    ...
    isLoading: boolean;
    constructor(store: Store<AppState>, router: Router, data: AlarmRuleDialogData, dialogRef: MatDialogRef<AlarmRuleDialogComponent, CalculatedField>, calculatedFieldsService: CalculatedFieldsService, destroyRef: DestroyRef, cfFormService: CalculatedFieldFormService);
